...
class ContactLeadResource extends Resource
{
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('status')
                    ...
                    ->icon(function ($state): ?string {
                        $enum = $state instanceof ContactLeadStatus
                            ? $state
                            : ContactLeadStatus::tryFrom((string) $state);
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('email')
                    ...
                    ->icon('heroicon-o-envelope')
                    ->color('primary')
                    ->url(fn (ContactLead $record): string => static::getUrl('email', ['record' => $record])),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'email' => Pages\EmailContactLead::route('/{record}/email'),
        ];
    }
