...
class ViewContactLead extends ViewRecord
{
    ...
    /**
     * Get the Send Email action for the View page header.
     */
    protected function getSendEmailAction(): Actions\Action
    {
        return Actions\Action::make('send_email')
            ->label('Send Email')
            ...
            ->form([
                ...
                Forms\Components\TextInput::make('subject')
                    ...
                    ->required()
                    ->maxLength(255)
                    ->default(fn (): string => ContactLeadEmailTemplates::for($this->record, 'initial_reply')['subject']),
                Forms\Components\Textarea::make('body')
                    ->label('Body')
                    ->required()
                    ->rows(12)
                    ->default(fn (): string => ContactLeadEmailTemplates::for($this->record, 'initial_reply')['body']),
            ])
