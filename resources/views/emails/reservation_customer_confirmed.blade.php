...
<head>
    ...
    <title>{{ __('emails.reservation.customer_confirmed_subject', ['restaurant' => $restaurant->name], $locale) }}</title>
    <style>
        body {
...
<body>
    ...
    <p>{{ __('emails.reservation.customer_confirmed_intro', [], $locale) }}</p>

    <div class="details">
        <h2>{{ __('emails.reservation.customer_confirmed_details_title', [], $locale) }}</h2>
        <ul>
    ...
    <p>{{ __('emails.reservation.customer_confirmed_outro', [], $locale) }}</p>

    <div class="footer">
        <p>{{ __('emails.reservation.customer_confirmed_signature', ['restaurant' => $restaurant->name], $locale) }}</p>
    </div>
</body>
</html>
