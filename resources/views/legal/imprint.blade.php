...
<head>
    ...
    {{-- SEO Meta Tags --}}
    <title>{{ __('landing.legal.imprint.title') }} – in.today</title>
    <meta name="description" content="{{ __('landing.legal.imprint.meta_description') }}">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                <h1 class="text-4xl md:text-5xl font-extrabold text-primary mb-4">
                    {{ __('landing.legal.imprint.title') }}
                </h1>
                <p class="text-lg text-secondary max-w-2xl mx-auto">
                    {{ __('landing.legal.imprint.subtitle') }}
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-12 md:py-16 bg-page">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-card rounded-2xl shadow-lg p-8 md:p-12 border border-default space-y-8">
                ...
                @php($sections = __('landing.legal.imprint.sections'))
